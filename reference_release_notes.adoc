...
È possibile accedere a. https://library.netapp.com/ecm/ecm_download_file/ECMLP2879854["Note sulla versione di ONTAP Select 9.10.1"^] per visualizzare i dettagli sulla versione corrente.
